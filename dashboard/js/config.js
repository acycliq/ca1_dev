function config() {
    return {
            ...
            cellData: 'https://api.github.com/repos/acycliq/ca1_dev/contents/dashboard/data/cellData',
            geneData: 'https://api.github.com/repos/acycliq/ca1_dev/contents/dashboard/data/geneData',
            cellCoords: 'https://api.github.com/repos/acycliq/ca1/contents/dashboard/data/cellCoords',
